...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-[#071025] to-black flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-gradient-to-b from-white/3 to-white/2 backdrop-blur-md border border-white/6 rounded-2xl shadow-2xl p-8">
        ...
        <div className="flex flex-col items-center">
          <div className="flex justify-center items-center max-h-[280px] mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-40 h-40" viewBox="0 0 20 20" fill="currentColor" aria-hidden>
          ...
          <button
            ...
            className="mx-auto w-auto inline-flex items-center justify-center gap-3 px-6 py-4 rounded-xl text-white font-medium shadow-lg transform transition hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-indigo-500/30 bg-gradient-to-r from-indigo-500 via-violet-500 to-pink-500"
          >
            Login with Passkey
          </button>
